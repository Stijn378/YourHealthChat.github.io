export const PrivacyPolicyExtension = {
  ...
  render: async ({ trace, element }) => {
    ...
    policyText.innerHTML = `Olivia is an AI assistant that helps you explore IndyVit products and supplements. She can offer personalized suggestions based on information you provide, such as a health report.<br/><br/>Her recommendations are intended to support your decisions and are not a substitute for professional medical advice. For any health concerns, consult a licensed healthcare provider.<br/><br/>By clicking ‘Accept’, you acknowledge that Olivia is a digital assistant and that your use of this feature is subject to the <a href="https://indyvit.com/en/policies/privacy-policy" target="_blank">IndyVit Privacy Policy</a> and the <a href="https://yourhealthchat.com/privacy-policy/" target="_blank">YourHealthChat Privacy Policy</a>`;
